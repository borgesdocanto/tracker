...
const sections = [
  { title: "1. Quiénes somos", body: "InstaCoach es un servicio de seguimiento de productividad comercial para el sector inmobiliario, operado desde la República Argentina. Podés contactarnos en hola@instacoach.com.ar." },
  ...
  { title: "3. Para qué usamos tus datos", body: "Usamos tu información exclusivamente para: mostrar tu dashboard de productividad, generar el análisis semanal de Insta Coach, enviarte el reporte semanal por email y gestionar tu suscripción. No compartimos ni vendemos tus datos con terceros." },
  ...
  { title: "5. Retención de datos", body: "Conservamos tus datos mientras tu cuenta esté activa. Si cancelás tu suscripción o solicitás la eliminación de tu cuenta, eliminamos todos tus datos dentro de los 30 días siguientes. Para solicitar la eliminación, escribinos a hola@instacoach.com.ar." },
  { title: "6. Servicios de terceros", body: "InstaCoach utiliza los siguientes servicios externos: Google OAuth y Calendar API (autenticación y lectura de agenda), MercadoPago (procesamiento de pagos — no almacenamos datos de tarjetas), Resend (envío de emails transaccionales) y Anthropic Claude (generación del análisis de IA — procesamos tu información de actividad, no datos personales identificatorios)." },
  ...
  { title: "10. Contacto", body: "Para cualquier consulta sobre privacidad, escribinos a hola@instacoach.com.ar. Respondemos en un plazo máximo de 5 días hábiles." },
];
...
export default function Privacidad() {
  ...
  return (
    <div style={{ background: "#f9fafb", minHeight: "100vh", fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
      <Head><title>Política de Privacidad — InstaCoach</title></Head>
