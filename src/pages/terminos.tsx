...
const sections = [
  { title: "1. Aceptación de los términos", body: "Al crear una cuenta y usar InmoCoach, aceptás estos términos en su totalidad. Si no estás de acuerdo con alguna parte, no podés usar el servicio. El uso continuado del servicio implica la aceptación de cualquier actualización de estos términos." },
  { title: "2. Descripción del servicio", body: "InmoCoach es una plataforma SaaS que sincroniza tu Google Calendar para detectar reuniones comerciales cara a cara, medir tu productividad y generar análisis personalizados mediante inteligencia artificial. El servicio incluye dashboard de actividad, reporte semanal por email y, según el plan, funcionalidades de equipo para brokers." },
  { title: "3. Registro y cuenta", body: "Para usar InmoCoach necesitás una cuenta de Google válida. Sos responsable de mantener la confidencialidad de tu sesión. Cada cuenta es personal e intransferible. No podés compartir tu acceso con otras personas ni crear cuentas múltiples para un mismo usuario." },
  { title: "4. Planes y pagos", body: "InmoCoach ofrece un período de prueba gratuito de 7 días con acceso completo. Una vez vencido el período de prueba, el acceso requiere una suscripción mensual activa. Los precios están expresados en pesos argentinos (ARS) y se procesan a través de MercadoPago. Las suscripciones se renuevan automáticamente cada mes. Podés cancelar en cualquier momento desde tu cuenta de MercadoPago." },
  { title: "5. Política de reembolsos", body: "Dado que ofrecemos 7 días de prueba gratuita sin restricciones, no ofrecemos reembolsos una vez procesado el pago. Si tenés problemas con el servicio, escribinos a hola@inmocoach.com.ar y lo resolvemos." },
  { title: "6. Uso aceptable", body: "Podés usar InmoCoach para gestionar tu actividad comercial personal y de tu equipo. No podés usar el servicio para actividades ilegales, revender el acceso a terceros, intentar acceder a datos de otros usuarios, hacer ingeniería inversa del software ni sobrecargar los servidores con solicitudes automatizadas." },
  { title: "7. Propiedad intelectual", body: "InmoCoach y todos sus componentes (software, diseño, textos, marca) son propiedad de sus creadores y están protegidos por las leyes de propiedad intelectual argentinas e internacionales. Los datos de tu actividad comercial son tuyos — InmoCoach no reclama propiedad sobre ellos." },
  { title: "8. Disponibilidad del servicio", body: "Nos esforzamos por mantener InmoCoach disponible el 99% del tiempo, pero no garantizamos disponibilidad ininterrumpida. Podemos realizar mantenimientos programados notificando con anticipación. No somos responsables por pérdidas derivadas de interrupciones del servicio." },
  { title: "9. Limitación de responsabilidad", body: "InmoCoach es una herramienta de medición y análisis. El análisis de Inmo Coach es orientativo y no reemplaza el criterio profesional del usuario. No somos responsables por decisiones comerciales tomadas en base al análisis del servicio. La responsabilidad máxima de InmoCoach ante cualquier reclamo no superará el monto abonado en los últimos 3 meses de suscripción." },
  { title: "10. Cancelación y cierre de cuenta", body: "Podés cancelar tu suscripción en cualquier momento. Al cancelar, mantenés acceso hasta el fin del período pago. Podés solicitar el cierre completo de tu cuenta escribiendo a hola@inmocoach.com.ar. Nos reservamos el derecho de suspender cuentas que violen estos términos." },
  ...
  { title: "12. Contacto", body: "Para consultas sobre estos términos, escribinos a hola@inmocoach.com.ar." },
];
...
export default function Terminos() {
  ...
  return (
    <div style={{ background: "#f9fafb", minHeight: "100vh", fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
      <Head><title>Términos de Uso — InmoCoach</title></Head>
